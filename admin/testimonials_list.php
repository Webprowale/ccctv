...
$carry = mysqli_query($conn, "SELECT * FROM project ");
...
// Query to count the number of IDs in the table
$sql_count = "SELECT COUNT(id) AS id_count FROM testimonials"; // Replace 'faq' with your table name
$result_count = mysqli_query($conn, $sql_count);
$id_count = 0;
if ($result_count) {
    $row_count = mysqli_fetch_assoc($result_count);
                ...
                <div class="col-lg-7">
                    <div class="single_user_pil d-flex align-items-center justify-content-between">
                        <div class="user_pils_thumb d-flex align-items-center">
                            ...
                            <span class="f_s_14 f_w_400 text_color_11"><?php echo $row['name']; ?></span>
                        </div>
                        <div class="user_info">
                            <?php echo $row['role']; ?>
                        </div>
