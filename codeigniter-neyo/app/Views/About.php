...
<?= $this->section('content') ?>
     <!-- PAGE TITLE
                        ...
                        <div class="ps-lg-1-9 ps-xl-7">
                            ...
                            <div class="row mb-1-9 mt-n1-9">
                                <div class="col-sm-6 mt-1-9">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="img/icons/icon-01.png" alt="Icon Image">

                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="h5">Video Intercoms</h4>
                                ...
                                <div class="col-sm-6 mt-1-9">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="img/icons/icon-02.png" alt="Icon Image">

                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="h5">New Technology</h4>
                                            <p class="mb-0">Latest technology of best security system.</p>
        ...
        <!-- COUNTER
        ================================================== -->
        <section class="bg-secondary rounded-lg py-7 bg-img text-center rounded-xl mx-xl-11" data-background="img/bg/bg-06.png">
            <div class="container">
                <div class="row mt-n1-6">
                    <div class="col-sm-6 col-md-3 mt-1-6 text-center wow fadeIn" data-wow-delay="50ms">
                        <h3 class="display-13 display-md-11 display-lg-8 mb-1 text-white"><span class="countup">467</span>+</h3>
                        <p class="mb-0 text-white opacity9">Project Complete</p>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-1-6 text-center wow fadeIn" data-wow-delay="100ms">
                        <h3 class="display-13 display-md-11 display-lg-8 mb-1 text-white"><span class="countup">30</span>k</h3>
                        <p class="mb-0 text-white opacity9">Happy Client</p>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-1-6 text-center wow fadeIn" data-wow-delay="150ms">
                        <h3 class="display-13 display-md-11 display-lg-8 mb-1 text-white"><span class="countup">236</span></h3>
                        <p class="mb-0 text-white opacity9">Dealer Equipment</p>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-1-6 text-center wow fadeIn" data-wow-delay="200ms">
                        <h3 class="display-13 display-md-11 display-lg-8 mb-1 text-white"><span class="countup">50</span>+</h3>
                        <p class="mb-0 text-white opacity9">Award Winner</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="position-relative pt-0">
            <div class="container">
                <div class="section-heading">
                    <span class="">How It's Work</span>
                    <h2 class="h1">Involves just a few easy process steps</h2>
                </div>
                <div class="row mt-n1-9">
                    <div class="col-sm-6 col-lg-3 mt-2-2 wow fadeIn" data-wow-delay="50ms">
                        <div class="process-style1 first">
                            <div class="icon-box icon-document"></div>

                            <div class="process-content">
                                <h3 class="h5 mb-3">Get Quotes</h3>
                                <h4 class="h1 mb-0">01</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mt-2-2 wow fadeIn" data-wow-delay="100ms">
                        <div class="process-style1 ">
                            <div class="icon-box icon-profile-male"></div>

                            <div class="process-content">
                                <h3 class="h5 mb-3">Consultation</h3>
                                <h4 class="h1 mb-0">02</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mt-2-2 wow fadeIn" data-wow-delay="150ms">
                        <div class="process-style1 third">
                            ...
                            <div class="process-content">
                                ...
                                <h4 class="h1 mb-0">03</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mt-2-2 wow fadeIn" data-wow-delay="200ms">
                        <div class="process-style1 ">
                            <div class="icon-box icon-globe"></div>

                            <div class="process-content">
                                <h3 class="h5 mb-3">Install CCTV</h3>
                                <h4 class="h1 mb-0">04</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="testimonial">
            ...
            <div class="d-none d-lg-inline-block p-3 border border-width-2 border-secondary position-absolute rounded-circle top-10 left-25 ani-top-bottom"></div>
